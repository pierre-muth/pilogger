...
public class ProbeManagerSwing implements ActionListener, ProbeManager {
	public static String onlineFileLocalDirectory = "/home/pi/pilogger/logs/online/";
	public static String configFileDirectory = "/home/pi/pilogger/config/";
	...
	public ProbeManagerSwing(PiloggerGUI gui) {
		this.gui = gui;
		initTimeScaleMenu();
